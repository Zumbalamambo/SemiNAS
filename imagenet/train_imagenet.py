...
def main():
    ...
    train_queue, valid_queue, model, train_criterion, eval_criterion, optimizer, scheduler = build_imagenet(model_config, model_state_dict, optimizer_state_dict, epoch=epoch-1, step=-1)
